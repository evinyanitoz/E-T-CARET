<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="stokcikis.aspx.cs" Inherits="WebApplication21.stokcikis" %>
        ...
        <table class="auto-style42" style="background-color: #CCCCFF">
            <tr>
                <td class="auto-style48" colspan="2" style="background-color: #003366"><strong>
                    <asp:Label ID="Label4" runat="server" CssClass="auto-style47" ForeColor="White" Text="Stok Çıkış İşlemleri"></asp:Label>
                    </strong></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" Height="40px" Text="Stok Çıkışı Yap" Width="152px" OnClick="Button2_Click" />
                    &nbsp;<asp:Label ID="Label5" runat="server" ForeColor="#FF3300" Text="Label"></asp:Label>
                </td>
            </tr>
        </table>
        &nbsp;</p>
